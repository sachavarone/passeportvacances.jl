...
function writeSolution(pathtodata::String, sol::DataFrame)
    ...
    pathsolution = string(pathtodata, "solution/")
    # check if directory exists
    if !isdir(pathsolution)
        # create subdirectory
        mkdir(pathsolution)
    end # if !isdir(string(pathtodata, "solution/")
    # filename for solution
    filenameSolution = string(pathsolution, "solution.csv")
...
function writeRemainder(pathtodata::String, df_remainder::DataFrame)
    ...
    filenameRemainder = string(pathsolution, "remainder.csv")
    # write solution to a file
